...
constexpr uint32_t MAGIC_NBN2 = 0x324E424E;
constexpr uint32_t MAGIC_NMTB = 0x42544D4E;
constexpr uint32_t MAGIC_NDYN = 0x4E59444E;
constexpr uint32_t MAGIC_NLC2 = 0x32434C4E;
constexpr uint32_t MAGIC_NCLS = 0x534C434E;
...
struct Chunk {
    ...
    std::string GetDescription() const {
        ...
        case ChunkType::NBN2: return "Skeleton Bones";
        case ChunkType::NMTB: return "Motion Blend";
        case ChunkType::NDYN: return "Dynamic Physics";
        case ChunkType::NLC2: return "Bone Constraints";
        case ChunkType::NCLS: return "Collision Shape";
